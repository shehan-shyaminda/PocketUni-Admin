...
public class AddAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreateAdmin = findViewById(R.id.btnAddAdmin);
        adminEmail = findViewById(R.id.txt_adminEmail);
        customProgressDialog = new CustomProgressDialog(AddAdminActivity.this);
        ...
        btnCreateAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(adminEmail.getText().toString().isEmpty()){
                    ...
                    new CustomAlertDialog().negativeAlert(AddAdminActivity.this, "Oops!", "Something went wrong.\nPlease check email address & try again!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                }else{
                    ...
                    db.collection("Admin").document(adminEmail.getText().toString().trim().toUpperCase()).set(adminData(adminEmail.getText().toString().trim().toLowerCase(), sb.toString()))
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    try {
                                        ...
                                        Thread thread = new Thread(new Runnable() {
                                            ...
                                            public void run() {
                                                try {
                                                    ...
                                                    customProgressDialog.dismissProgress();
                                                    startActivity(new Intent(AddAdminActivity.this, SuccessMailActivity.class));
                                                    Animatoo.animateSlideLeft(AddAdminActivity.this);
                                        ...
                                        customProgressDialog.dismissProgress();
                                        new CustomAlertDialog().negativeAlert(AddAdminActivity.this, "Oops!", "Check Your Email Address & Please try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
                                        e.printStackTrace();
                                    } catch (MessagingException e) {
                                        customProgressDialog.dismissProgress();
                                        new CustomAlertDialog().negativeAlert(AddAdminActivity.this, "Oops!", "Something went wrong.\nPlease try again later!","OK", CFAlertDialog.CFAlertStyle.ALERT);
    ...
    private Map adminData(String email, String password) {
        Map<String, Object> adminData = new HashMap<>();
        adminData.put("userEmail", email);
        adminData.put("userName", "");
        adminData.put("userPassword", password);
        adminData.put("userType", "N");
